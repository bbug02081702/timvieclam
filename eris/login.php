              ...
              <div class="modal-content">
                ...
                <!-- <form action="process.php?action=login" enctype="multipart/form-data" method="post"> -->
                        ...
                        <div class="login-box-body" style="border: solid 1px #ddd;padding: 35px;min-height: 350px;"> 
                          ...
                          <form action="" method="post">
                            <div class="form-group has-feedback">
                              <input type="text" class="form-control" placeholder="Tên người dùng" name="user_email" id="user_email">
                          ...
                          <a href="<?php echo web_root; ?>index.php?q=register" class="text-center">Đăng ký tài khoản</a>
                  ...
                  <div class="modal-footer">
                    ...
                    name="btnlogin" id="btnlogin"  >Đăng nhập</button>
                  </div>
                <!-- </form> -->
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
