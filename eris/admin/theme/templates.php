...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo web_root.'admin/user/index.php?view=view&id='.$_SESSION['ADMIN_USERID'] ;?>" class="btn btn-default btn-flat">Hồ sơ</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo web_root ;?>admin/logout.php" class="btn btn-default btn-flat">Đăng xuất</a>
                </div>
              </li>
            </ul>
          </li>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'company') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/company/">
            <i class="fa fa-building"></i> <span>Công ty
        </li>
        <li class="<?php echo (currentpage() == 'vacancy') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/vacancy/">
            <i class="fa fa-suitcase"></i> <span>Vị trí còn trống</span> 
          </a>
        </li>
       ...
       <!--  <li class="treeview">
         ...
         <li class="<?php echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/user/">
            <i class="fa fa-user"></i> <span>Quản lý thành viên</span> </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="#">nhóm 16 cnpm</a>.</strong> All rights
    reserved.
  </footer>
