...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Danh sách các hạng mục <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Thêm danh mục</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
