...
<head>
<meta charset="utf-8">
<title>Tìm kiếm việc làm <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>0364289473</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Tìm việc làm<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='advancesearch'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=advancesearch">Tìm kiếm nâng cao</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">Việc làm theo công ty</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function">Việc làm theo chức vụ</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle">Công việc theo chức danh</a></li>
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Việc làm phổ biến <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Việc làm đang tuyển</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='About'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=About">Giới thiệu về chúng tôi</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Liên hệ chúng tôi</h5>
          <address>
          <strong>Công ty chúng tôi</strong><br>
          vnext software<br>
           vinh nghệ an</address>
          <p>
            <i class="icon-phone"></i> 0364289473 <br>
            <i class="icon-envelope-alt"></i> vnext@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Danh sách</h5>
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php">Trang chủ</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=company">Công ty</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=hiring">Thuê</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=About">Giới thiệu chúng tôi</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=Contact">Liên hệ chúng tôi</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
