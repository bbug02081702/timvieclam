...
<div class="col-sm-12 content-body" >  
	...
	<div class="col-sm-6">
		<ul>
            <li><i class="fp-ht-bed"></i>Số nhân viên yêu cầu : <?php echo $job->REQ_NO_EMPLOYEES; ?></li>
            <li><i class="fp-ht-food"></i>Lương: <?php echo number_format($job->SALARIES,2);  ?></li>
            <li><i class="fa fa-sun-"></i>Thời gian làm nghề : <?php echo $job->DURATION_EMPLOYEMENT; ?></li>
        </ul>
	</div> 
	<div class="col-sm-6">
		<ul> 
            <li><i class="fp-ht-tv"></i>Giới tính ưa thích : <?php echo $job->PREFEREDSEX; ?></li>
            <li><i class="fp-ht-computer"></i>Khu vực tuyển dụng : <?php echo $job->SECTOR_VACANCY; ?></li>
        </ul>
	</div>
	<div class="col-sm-12">
		<p>Mô tả công việc : </p>   
...
<p><i class="fa fa-paperclip"></i>  Tệp đính kèm</p>
	<div class="col-sm-12 slider">
		 <h3>Tải xuống hồ sơ <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Tại đây</a></h3>
	</div>  
	<div class="col-sm-12">
		<p>Phản hồi</p>
	...
	<div class="col-sm-12  submitbutton "> 
		<a href="index.php?view=appliedjobs" class="btn btn-primary fa fa-arrow-left">Thoát</a>
	</div> 
</div>
</form>