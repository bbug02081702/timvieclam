    ...
    <div class="row">
        ...
        <div class="col-sm-3"><!--left col-->
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item text-right"><span class="pull-left"><strong>Tên thật</strong></span> 
          ...
          <div class="box box-solid">  
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked"> 
                <li class="<?php echo ($view=='appliedjobs' || $view=='') ? 'active': '';?>"><a href="<?php echo web_root.'applicant/index.php?view=appliedjobs'; ?>"><i class="fa fa-list"></i> Việc làm đã ứng dụng
                   </a></li>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Chọn.</h4>
                                </div>
